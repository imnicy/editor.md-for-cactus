...
class Settings {
	...
	function admin_menu() {
		add_plugins_page( $this->plugin_name . __( ' Options', $this->text_domain ), $this->plugin_name, 'manage_options', 'editormd-for-cactus-settings', array( $this, 'plugin_page' ) );
	}
	...
	function get_settings_sections() {
		...
		function upgradeEditormdFile() {
			if ( WP_EDITORMD_STATIC_FILE_VER !== WP_EDITORMD_VER ) {
				...
				return '<span class="error">'. __( 'Status: Please Update!', 'editormd' ) .'</span><a href="https://github.com/imnicy/editor.md-for-cactus/releases/latest">'. __( 'Downaload', 'editormd' ) .'</a>';
			} else {
