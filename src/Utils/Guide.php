...
class Guide {
	...
	public function editormd_pointer_footer_script() {
		...
		$pointer_content = __( '<h3>Hello! New Editor.md For Cactus</h3>', $this->text_domain ); // Title should be <h3> for proper formatting.
		$pointer_content .= '<p>' .__( 'Welcome to the new version of WordPress Editor.md editor, please go to Editor.md For Cactus to configure related settings!', $this->text_domain ) . '</p>';
		// In JavaScript below:
